/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c8eb0c731955dc3b2ec658d5fcbc5235)
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		DB: D1Database;
		AI: Ai;
		FIREBASE_PROJECT_ID: "vitally-a056d";
		AI_GATEWAY_ID: "health-app-staging";
	...
	interface Env {
		...
		AI: Ai;
		FIREBASE_PROJECT_ID: "vitally-a056d";
		AI_GATEWAY_ID: "health-app-staging" | "health-app";
		SESSION_SECRET: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIREBASE_PROJECT_ID" | "AI_GATEWAY_ID" | "SESSION_SECRET">> {}
}
