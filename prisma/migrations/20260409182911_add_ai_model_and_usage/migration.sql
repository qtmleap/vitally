...
INSERT INTO "new_meal_templates" ("created_at", "id", "meal_type", "name", "user_id") SELECT "created_at", "id", "meal_type", "name", "user_id" FROM "meal_templates";
...
INSERT INTO "new_user_profiles" ("activity_level", "age", "body_fat_pct", "calorie_goal", "created_at", "gender", "goal", "height_cm", "id", "updated_at", "user_id", "weight_kg") SELECT "activity_level", "age", "body_fat_pct", "calorie_goal", "created_at", "gender", "goal", "height_cm", "id", "updated_at", "user_id", "weight_kg" FROM "user_profiles";
